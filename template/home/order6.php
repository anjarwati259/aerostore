        ...
        <div class="row mt-2" style="margin:0px">
            <div class="col-md-12 col-sm-12 col-lg-4">
                <div class="text-center text-md-left mb-2">
                    <img src="freefire.png" class="img-responsive rounded mb-2" width="200px" height="200px">
                </div>
                <h5>Free Fire</h5>
...
6. Tunggu 1 - 3 Menit (Jika Event Max 6 Jam) Diamond Akan Masuk Otomatis Di Akun Anda</b></font>
<br>
<br>
                                ...
                                <h5 style="margin-left: 40px;">Pilih nominal</h5>
                                    <hr><div class="mt-4">
                                        <div class="panel-topup">
                                            <input type="radio" id="service0" name="service" value="411"><label onclick="ganti('label_service0')" id="label_service0"  for="service0"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">5 Diamonds <br>Rp 873</label><input type="radio" id="service1" name="service" value="404"><label onclick="ganti('label_service1')" id="label_service1"  for="service1"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">20 Diamonds <br>Rp 2.920</label><input type="radio" id="service2" name="service" value="412"><label onclick="ganti('label_service2')" id="label_service2"  for="service2"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">50 Diamonds <br>Rp 7.020</label><input type="radio" id="service3" name="service" value="410"><label onclick="ganti('label_service3')" id="label_service3"  for="service3"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">70 Diamond <br>Rp 9.640</label><input type="radio" id="service4" name="service" value="405"><label onclick="ganti('label_service4')" id="label_service4"  for="service4"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">140 Diamonds <br>Rp 19.000</label><input type="radio" id="service5" name="service" value="406"><label onclick="ganti('label_service5')" id="label_service5"  for="service5"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">355 Diamonds <br>Rp 47.500</label><input type="radio" id="service6" name="service" value="413"><label onclick="ganti('label_service6')" id="label_service6"  for="service6"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">720 Diamonds <br>Rp 95.000</label><input type="radio" id="service7" name="service" value="414"><label onclick="ganti('label_service7')" id="label_service7"  for="service7"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">2000 Diamonds <br>Rp 259.100</label><input type="radio" id="service8" name="service" value="348"><label onclick="ganti('label_service8')" id="label_service8"  for="service8"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">7290 Diamonds <br>Rp 950.000</label><input type="radio" id="service9" name="service" value="408"><label onclick="ganti('label_service9')" id="label_service9"  for="service9"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">36500 Diamonds <br>Rp 4.750.000</label><input type="radio" id="service10" name="service" value="398"><label onclick="ganti('label_service10')" id="label_service10"  for="service10"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">73100 Diamonds <br>Rp 9.500.000</label><input type="radio" id="service11" name="service" value="352"><label onclick="ganti('label_service11')" id="label_service11"  for="service11"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">Membership Mingguan <br>Rp 30.000</label><input type="radio" id="service12" name="service" value="397"><label onclick="ganti('label_service12')" id="label_service12"  for="service12"><img style="margin-right: 3px !important;" height="18px" src="https://aoshimarket.com/assets/images/1615286239.png">Membership Bulanan <br>Rp 145.000</label>                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
