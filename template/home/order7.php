        ...
        <div class="row mt-2" style="margin:0px">
            <div class="col-md-12 col-sm-12 col-lg-4">
                <div class="text-center text-md-left mb-2">
                    <img src="sausageman.png" class="img-responsive rounded mb-2" width="200px" height="200px">
                </div>
                <h5>Sausage Man</h5>
...
<br>
1. Masukan ID <br/>
2. Pilih nominal Candies <br/>
3. Pilih Metode Pembayaran<br/>
4. Masukan Nomor WhatsApp Kamu<br/>
5. Klik Beli Sekarang & Lakukan Pembayaran<br/>
6. Tunggu 10 - 180 Menit (Maksimal 24 Jam) Candies Akan Masuk Otomatis Di Akun Anda</b></font>
<br>
<br>
                                ...
                                <h5 style="margin-left: 40px;">Pilih nominal</h5>
                                    <hr><div class="mt-4">
                                        <div class="panel-topup">
                                            <input type="radio" id="service0" name="service" value="477"><label onclick="ganti('label_service0')" id="label_service0"  for="service0">60 Candies <br>Rp 14.700</label><input type="radio" id="service1" name="service" value="478"><label onclick="ganti('label_service1')" id="label_service1"  for="service1">180 Candies <br>Rp 44.700</label><input type="radio" id="service2" name="service" value="479"><label onclick="ganti('label_service2')" id="label_service2"  for="service2">316 Candies <br>Rp 74.500</label><input type="radio" id="service3" name="service" value="480"><label onclick="ganti('label_service3')" id="label_service3"  for="service3">718 Candies <br>Rp 148.000</label><input type="radio" id="service4" name="service" value="481"><label onclick="ganti('label_service4')" id="label_service4"  for="service4">1368 Candies <br>Rp 298.000</label><input type="radio" id="service5" name="service" value="482"><label onclick="ganti('label_service5')" id="label_service5"  for="service5">2118 Candies <br>Rp 473.000</label><input type="radio" id="service6" name="service" value="483"><label onclick="ganti('label_service6')" id="label_service6"  for="service6">3548 Candies <br>Rp 745.000</label><input type="radio" id="service7" name="service" value="484"><label onclick="ganti('label_service7')" id="label_service7"  for="service7">7048 Candies <br>Rp 1.460.000</label>                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
