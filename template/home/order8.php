        ...
        <div class="row mt-2" style="margin:0px">
            <div class="col-md-12 col-sm-12 col-lg-4">
                <div class="text-center text-md-left mb-2">
                    <img src="higgsdomino.png" class="img-responsive rounded mb-2" width="200px" height="200px">
                </div>
                <h5>Higgs Domino</h5>
                                ...
                                <h5 style="margin-left: 40px;">Pilih nominal</h5>
                                    <hr><div class="mt-4">
                                        <div class="panel-topup">
                                            <input type="radio" id="service0" name="service" value="477"><label onclick="ganti('label_service0')" id="label_service0"  for="service0">100 M <br>Rp 7.500</label><input type="radio" id="service1" name="service" value="478"><label onclick="ganti('label_service1')" id="label_service1"  for="service1">300 M <br>Rp 21.500</label><input type="radio" id="service2" name="service" value="479"><label onclick="ganti('label_service2')" id="label_service2"  for="service2">500 M <br>Rp 35.000</label><input type="radio" id="service3" name="service" value="480"><label onclick="ganti('label_service3')" id="label_service3"  for="service3">1 B <br>Rp 70.000</label><input type="radio" id="service4" name="service" value="481"><label onclick="ganti('label_service4')" id="label_service4"  for="service4">2 B <br>Rp 138.000</label><input type="radio" id="service5" name="service" value="482"><label onclick="ganti('label_service5')" id="label_service5"  for="service5">5 B <br>Rp 345.000</label>                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
