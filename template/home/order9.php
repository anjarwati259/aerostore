        ...
        <div class="row mt-2" style="margin:0px">
            <div class="col-md-12 col-sm-12 col-lg-4">
                <div class="text-center text-md-left mb-2">
                    <img src="lifeaster.png" class="img-responsive rounded mb-2" width="200px" height="200px">
                </div>
                <h5>Life After</h5>
...
2. Pilih nominal Credits <br/>
3. Pilih Metode Pembayaran<br/>
4. Masukan Nomor WhatsApp Kamu<br/>
5. Klik Beli Sekarang & Lakukan Pembayaran<br/>
6. Tunggu 1 - 180 Menit(Maksimal 24 Jam) Credits Akan Masuk Otomatis Di Akun Anda</b></font>
<br>
<br>
...
<div class="text-white text-center position-absolute circle-primary">1</div><h5 style="margin-left: 40px;">Lengkapi data</h5>
			<hr><div class="form-row mt-4">
				...
				<div class="col">
					<select name="zoneid" class="form-control" onChange="getServer(this);">
						<option value="0" disabled="" selected="">Pilih Server</option>
						<option value="500001">MiskaTown</option>
						<option value="500002">SandCastle</option>
						<option value="500003">MouthSwamp</option>
						<option value="500004">RedwoodTown</option>
						<option value="500005">Obelisk</option>
						<option value="510001">FallForest</option>
						<option value="510002">MountSnow</option>
						<option value="520001">NancyCity</option>
						<option value="520002">CharlesTown</option>
						<option value="520003">SnowHighlands</option>
						<option value="520004">Santopany</option>
						<option value="520005">LevinCity</option>
						<option value="500006">NewLand</option>
						<option value="520006">MileStone</option>
					</select>
                                ...
                                <h5 style="margin-left: 40px;">Pilih nominal</h5>
                                    <hr><div class="mt-4">
                                        <div class="panel-topup">
                                            <input type="radio" id="service0" name="service" value="604"><label onclick="ganti('label_service0')" id="label_service0"  for="service0">65 Credits <br>Rp 16.000</label><input type="radio" id="service1" name="service" value="605"><label onclick="ganti('label_service1')" id="label_service1"  for="service1">330 Credits <br>Rp 78.000</label><input type="radio" id="service2" name="service" value="606"><label onclick="ganti('label_service2')" id="label_service2"  for="service2">558 Credits <br>Rp 108.000</label><input type="radio" id="service3" name="service" value="607"><label onclick="ganti('label_service3')" id="label_service3"  for="service3">1108 Credits <br>Rp 208.000</label><input type="radio" id="service4" name="service" value="608"><label onclick="ganti('label_service4')" id="label_service4"  for="service4">2268 Credits <br>Rp 403.000</label><input type="radio" id="service5" name="service" value="609"><label onclick="ganti('label_service5')" id="label_service5"  for="service5">3468 Credits <br>Rp 625.000</label><input type="radio" id="service6" name="service" value="610"><label onclick="ganti('label_service6')" id="label_service6"  for="service6">7768 Credits <br>Rp 1.305.000</label>                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
