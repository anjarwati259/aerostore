        ...
        <div class="row mt-2" style="margin:0px">
            <div class="col-md-12 col-sm-12 col-lg-4">
                <div class="text-center text-md-left mb-2">
                    <img src="lonamlfast.jpeg" class="img-responsive rounded mb-2" width="200px" height="200px">
                </div>
                <h5>Mobile Legends</h5>
                <span class="strip-primary"></span>
                <p class="mt-4 pr-4"><h6>Proses 1-5 Menit (Buka 24 Jam)</h6> <span class="strip-primary"></span>
...
<li>Tunggu 1-5 Menit Diamond Akan Masuk Otomatis Di Akun Anda. (Jika Event Maksimal 6 Jam)</li></ol>

<center><font size="4" color="#f33300"><b>Estimasi Proses Otomatis 1 - 5 Menit</b></font></center>
<!DOCTYPE html>
<html>
<head>
...
<div class="col-12 mb-3">
	<div class="card">
		...
		<h5 class="ml-5 mt-1">Lengkapi Data</h5>
			...
			<input name="layanan" type="hidden" value="Mobile Legends Super Fast"/>
                                ...
                                <div class="pt-1 text-white text-center position-absolute circle-primary">2</div>
                                    ...
                                    <div class="mt-4">
                                        <div class="panel-topup">
                                            <input type="radio" id="service0" name="service" value="86 Diamonds Rp 25.000"><label for="service0">86 Diamonds<br>Rp 25.000</label>
											<input type="radio" id="service1" name="service" value="172 Diamonds Rp 50.000"><label for="service1">172 Diamonds<br>Rp 50.000</label>
											<input type="radio" id="service2" name="service" value="257 Diamonds Rp 78.000"><label for="service2">257 Diamonds<br>Rp 78.000</label>
											<input type="radio" id="service3" name="service" value="514 Diamonds Rp 156.000"><label for="service3">514 Diamonds<br>Rp 156.000</label>
											<input type="radio" id="service4" name="service" value="706 Diamonds Rp 175.000"><label for="service4">706 Diamonds<br>Rp 175.000</label>
											<input type="radio" id="service5" name="service" value="1412 Diamonds Rp 340.000"><label for="service5">1412 Diamonds<br>Rp 340.000</label>
											<input type="radio" id="service6" name="service" value="2195 Diamonds Rp 481.000"><label for="service6">2195 Diamonds<br>Rp 481.000</label>
											<input type="radio" id="service7" name="service" value="3688 Diamonds Rp 787.000"><label for="service7">3688 Diamonds<br>Rp 787.000</label>
											<input type="radio" id="service8" name="service" value="5532 Diamonds Rp1.172.000"><label for="service8">5532 Diamonds<br>Rp1.172.000</label>
											<input type="radio" id="service9" name="service" value="9288 Diamonds Rp1.989.000"><label for="service9">9288 Diamonds<br>Rp1.989.000</label>
											<input type="radio" id="service10" name="service" value="Starlight Rp 135.000"><label for="service10">Starlight<br>Rp 135.000</label>
											<input type="radio" id="service11" name="service" value="Twilight Rp 135.000"><label for="service11">Twilight<br>Rp 135.000</label>
											<input type="radio" id="service12" name="service" value="Starlight+ Rp 310.000"><label for="service12">Starlight+<br>Rp 310.000</label>
