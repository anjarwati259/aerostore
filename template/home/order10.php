        ...
        <div class="row mt-2" style="margin:0px">
            <div class="col-md-12 col-sm-12 col-lg-4">
                <div class="text-center text-md-left mb-2">
                    <img src="dragonraja.png" class="img-responsive rounded mb-2" width="200px" height="200px">
                </div>
                <h5>Dragon Raja</h5>
...
6. Tunggu 10 - 180 Menit(Maksimal 24 Jam) Coupons Akan Masuk Otomatis Di Akun Anda</b></font>
<br>
<br>
                                ...
                                <h5 style="margin-left: 40px;">Pilih nominal</h5>
                                    <hr><div class="mt-4">
                                        <div class="panel-topup">
                                            <input type="radio" id="service0" name="service" value="593"><label onclick="ganti('label_service0')" id="label_service0"  for="service0">90 Coupons <br>Rp 18.000</label><input type="radio" id="service1" name="service" value="594"><label onclick="ganti('label_service1')" id="label_service1"  for="service1">337 Coupons <br>Rp 75.000</label><input type="radio" id="service2" name="service" value="595"><label onclick="ganti('label_service2')" id="label_service2"  for="service2">988 Coupons <br>Rp 180.000</label><input type="radio" id="service3" name="service" value="596"><label onclick="ganti('label_service3')" id="label_service3"  for="service3">2533 Coupons <br>Rp 430.000</label><input type="radio" id="service4" name="service" value="602"><label onclick="ganti('label_service4')" id="label_service4"  for="service4">3589 Coupons <br>Rp 595.000</label><input type="radio" id="service5" name="service" value="603"><label onclick="ganti('label_service5')" id="label_service5"  for="service5">7546 Coupons <br>Rp 1.250.000</label><input type="radio" id="service6" name="service" value="597"><label onclick="ganti('label_service6')" id="label_service6"  for="service6">15092 Coupons <br>Rp 2.480.000</label><input type="radio" id="service7" name="service" value="598"><label onclick="ganti('label_service7')" id="label_service7"  for="service7">Investment Funds <br>Rp 190.000</label><input type="radio" id="service8" name="service" value="599"><label onclick="ganti('label_service8')" id="label_service8"  for="service8">Investment Funds <br>Rp 255.000</label>                                      </div>
                                    </div>
                                </div>
                            </div>
                        </div>
